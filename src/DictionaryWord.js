            ...
            (this.props.isSelected) ?
                <div className={"dictionary-word"} style={{ flexDirection: "column", margin: "10px 0px" }}>
                    <div className={"dictionary-word-upper"}>
                        <div className={"dictionary-word-inputfield"} style={{ flex: 1, position: "relative" }}>
                        ...
                        <img src={arrow_img} />
                        <div className={"dictionary-word-inputfield"} style={{ flex: 1, position: "relative" }}>
                            <input style={{ width: "100%" }} placeholder="po polsku"
                    ...
                    <div className={"dictionary-word-lower"}>
                        <div className={"dictionary-word-inputfield"} style={{ flex: 4, position: "relative" }}>
                            <input style={{ width: "100%" }}
